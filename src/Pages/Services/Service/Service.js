...
const Service = (props) => {
    ...
    const { name, subtitle, image, id, price } = props.service
    return (
        <div className="transform bg-[#191f2e] hover:-translate-y-3 to-hover hover:bg-gray-800 text-center secondary-bg transition duration-300 rounded w-full shadow-lg mx-auto">
            ...
            <h2 className="px-5 pt-5 text-gray-200">{subtitle.slice(0, 30)}{",,,,,"}</h2>
            <h2 className="px-5 pt-5 text-gray-200"> price: {price}</h2>
            <NavLink
                to={`/services/${id}`}
